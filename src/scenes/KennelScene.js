...
import {
  WALL, ROOM, OUTSIDE, WORLD, BACK_DOOR, FRONT_DOOR, RECEPTION,
...
import {
  ...
  MESS_KEY, NEED_KEY, COMPUTER_KEY, UPGRADE_KEY, CAGE_KEY, CAGE_FG_KEY, EMPTY_CAGE_KEY,
  OVEN_KEY, SHELF_KEY, BOX_KEY, BAG_KEY, BED_KEY,
  YARD_DOOR_OPEN_KEY, YARD_DOOR_CLOSED_KEY,
  TRAVEL_TANK_KEY, POND_KEY,
} from '../art/props.js';
...
export default class KennelScene extends WithBirths(WithNight(WithRaccoon(WithSecretDragon(WithDevDrag(Phaser.Scene))))) {
  constructor() {
    super('Kennel');
  }
